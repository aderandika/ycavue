              ...
              <div class="col-lg-6">
                ...
                <div class="product-thumbs">
                  <carousel :dots="false" :nav="false" class="product-thumbs-track ps-slider">
                    <div
                      class="pt"
                      @click="changeImage(gambar_default)"
...
import HeaderYca from "@/components/HeaderYca.vue";
import FooterYca from "@/components/FooterYca.vue";
import RelatedYca from "@/components/RelatedYca.vue";
